...
This project is partly created for me to learn C++, DearImGUI and GLFW with a graphics API (here OpenGL).
I tried starting with Vulkan, but it is too complex for my use.

- GLFW opens windows with an OpenGL context.
...
```
git clone --recursive https://github.com/Physis21/go-score-counter.git
```

## About the 3rd party libraries in `vendor/`

- [OpenGL3](https://en.wikipedia.org/wiki/OpenGL) (Open Graphics Library) is an API used to render 2D or 3D graphics. It directly talks to the GPU. More specifically, it is a specification, written by the OpenGL ARB.
- (**not used**) [Vulkan](https://en.wikipedia.org/wiki/Vulkan) is a cross-platform API and open standard for 3D graphics and computing. It was intended to address the shortcomings of OpenGL, and allow developers more control over the GPU. It is designed to support a wide variety of GPUs, CPUs and operating systems, and modern multi-core CPUs also.
